...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CustomLoader/CustomLoader.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DDHTimerControl/DDHTimerControl.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DropDown/DropDown.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Drops/Drops.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SBDropDown/SBDropDown.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SCPageControl/SCPageControl.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SDWebImage/SDWebImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ScrollingPageControl/ScrollingPageControl.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Slider2/Slider2.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftAlertView/SwiftAlertView.framework"
